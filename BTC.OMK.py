...
text=str(input(cyan+" Wellcom BTC.OMK SMS B0MBER Entar To Continue [>] : "))

text=lightblue+"\t\tCreated By : "+yellow+"AFRAN.... 		Varson: 2.0"+cyan+"\n\n\t\t★★ "+purple+"BTC.OMK Team Member's"+cyan+"★★   \n"     
def header():
 print(logo)
 print(text)
 print(line)
...
n=2
while n==2:
 a=str(input(cyan+"\n\n\t\t[>] Entar BTC.OMK Security Key [>]"+green))
 if a=="linax40":
  print(green+"\n\n\t\t[ √ ] Request Accepted")
  n=3
 else:
...
for j in range (amount):
 ...
 print(str(j+1)+" 	C.E.O Request To SMS Done By Afran....")